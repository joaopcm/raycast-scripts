...
# @raycast.title Open Postman
# @raycast.mode silent

# Optional parameters:
# @raycast.icon https://svgl.app/library/postman.svg

# Documentation:
# @raycast.description Postman
...
tell application "Google Chrome"
    ...
    set targetURL to "https://usevain.postman.co/home"
    ...
    if (count of windows) > 0 then
        repeat with w from 1 to count of windows
            repeat with t from 1 to count of tabs of window w
                try
                    if URL of tab t of window w contains "postman.co" then
