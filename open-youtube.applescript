...
# @raycast.title Open YouTube
# @raycast.mode silent

# Optional parameters:
# @raycast.icon https://svgl.app/library/youtube.svg

# Documentation:
# @raycast.description YouTube
    ...
    if (count of windows) > 0 then
        repeat with w from 1 to count of windows
            repeat with t from 1 to count of tabs of window w
                try
                    if URL of tab t of window w contains "www.youtube.com" then
