...
# @raycast.title Open Notion Calendar
# @raycast.mode silent
...
# Documentation:
# @raycast.description Notion Calendar
...
tell application "Comet"
    ...
    set targetURL to "https://calendar.notion.so/"
    ...
    if (count of windows) > 0 then
        repeat with w from 1 to count of windows
            repeat with t from 1 to count of tabs of window w
                try
                    if URL of tab t of window w contains "calendar.notion.so" then
